...
import { ASCIIFontRenderable, BoxRenderable, CodeRenderable, DiffRenderable, ImageRenderable, InputRenderable, LineNumberRenderable, MarkdownRenderable, ScrollBoxRenderable, SelectRenderable, TabSelectRenderable, TextareaRenderable, TextAttributes, TextNodeRenderable, TextRenderable } from "@opentui/core";
...
import { createEffect, createMemo as createMemo2, getOwner, onCleanup as onCleanup3, runWithOwner, splitProps, untrack as untrack2 } from "solid-js/dist/solid.js";
...
var {
  ...
  createElement(tagName) {
    ...
    if (element instanceof ImageRenderable2) {
      onCleanup2(() => {
      ...
      case "style":
        ...
        if (node instanceof ImageRenderable2) {
          for (const prop in previousStyle) {
            if (Object.prototype.hasOwnProperty.call(nextStyle, prop))
              continue;
            if (prop !== "fit" && prop !== "protocol")
              continue;
            node[prop] = undefined;
          }
        }
...
function Portal(props) {
  ...
  createEffect(() => {
    ...
    onCleanup3(() => el.remove(container));
  }, undefined, {
    render: true
  });
  return marker;
...
import { children, createMemo as createMemo3, createSignal as createSignal3, ErrorBoundary, For, onCleanup as onCleanup4, splitProps as splitProps2 } from "solid-js/dist/solid.js";
var EMPTY_ENTRY_IDS = [];
